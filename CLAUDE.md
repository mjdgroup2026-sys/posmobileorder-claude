...
- **ชำระเงิน MJD Mobile Order — ✅ ต่อ SCB จริงแล้วและใช้งานได้ (พิสูจน์ด้วยเงินจริง 2026-09-09)**:
  ...
  `components/customer-paid-notice.tsx`) บนผังโต๊ะและหน้าแจ้งเตือน — จำเป็นเพราะ callback ปิดบิล
  แล้วคืนโต๊ะเป็นว่างในทรานแซคชันเดียวกัน พนักงานจึงเห็นแค่โต๊ะหายไปเฉย ๆ · แยกบิลที่ระบบปิดเอง
  ออกจากบิลที่พนักงานกดปิดด้วย `Sale.cashierId = SYSTEM_USER_ID` · คำนวณสดเช่นกัน หายเองใน 15 นาที
