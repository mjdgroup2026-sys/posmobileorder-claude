...
- **ชำระเงิน MJD Mobile Order — ✅ ต่อ SCB จริงแล้วและใช้งานได้ (พิสูจน์ด้วยเงินจริง 2026-09-09)**:
  ...
  จำเป็นเพราะ callback ปิดบิลแล้วคืนโต๊ะเป็นว่างในทรานแซคชันเดียวกัน พนักงานจึงเห็นแค่โต๊ะหายไป
  เฉย ๆ · แยกบิลที่ระบบปิดเองออกจากบิลที่พนักงานกดปิดด้วย `Sale.cashierId = SYSTEM_USER_ID` ·
  คำนวณสดเช่นกัน หายเองใน 15 นาที
